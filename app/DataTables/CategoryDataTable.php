...
class CategoryDataTable extends DataTable
{
    ...
    {
      return (new EloquentDataTable($query))->addIndexColumn()->addColumn('color',function($row){
                return '<span style="padding:15px;background-color:'.$row->color.';"></span>';
            })->addColumn('action', function ($row) {
                    $html = ' <a href="'.route("admin.terms.categories.edit",$row->id).'" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>';
                    $html .= '<a href="'.route("admin.terms.categories.show",$row->id).'" class="btn btn-info" title="View"><i class="fa fa-file"></i></a>';
                    $html .= '<a href="javascript:void(0);" class="btn btn-danger del_entity_form" title="Delete" item_id="'.$row->id.'" data-text="category"><i class="fa fa-trash"></i></a>';
                    return $html;
                    ...
                    return '<input data-id="'.$row->id.'" class="toggle-class" type="checkbox" data-size="sm" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-url="'.route("admin.terms.changeStatusCategory").'" data-on="Active" data-off="InActive" '.$checked.'>';
            ...
            })->rawColumns(['status','action','color','del']);
    }

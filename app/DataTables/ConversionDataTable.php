...
class ConversionDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))->addIndexColumn()->addColumn('icon',function($row){
            return get_fontawesome_icon_html($row->icon,'fa-lg');
                ...
                $html = ' <a href="'.route("admin.conversions.edit",$row->id).'" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>';
                $html .= '<a href="'.route("admin.conversions.show",$row->id).'" class="btn btn-info" title="View"><i class="fa fa-file"></i></a>';
                ...
                return '<input data-id="'.$row->id.'" class="toggle-class" type="checkbox" data-size="sm" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-url="'.route("admin.conversions.changeStatus").'" data-on="Active" data-off="InActive" '.$checked.'>';
     ...
     *
     * @param \App\Models\Conversion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Conversion $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('conversion_rate')->title('Conversion Rate')->searchable(false)
            ->orderable(true)
            ->exportable(false)
            ->printable(false),
    ...
    {
        return 'Conversion_' . date('YmdHis');
    }
}

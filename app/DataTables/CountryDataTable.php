...
class CountryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))->addIndexColumn()->addColumn('action', function ($row) {
                    $html = ' <a href="'.route("admin.terms.countries.edit",$row->id).'" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>';
                    $html .= '<a href="'.route("admin.terms.countries.show",$row->id).'" class="btn btn-info" title="View"><i class="fa fa-file"></i></a>';
                    $html .= '<a href="javascript:void(0);" class="btn btn-danger del_entity_form" title="Delete" item_id="'.$row->id.'" data-text="country"><i class="fa fa-trash"></i></a>';
                    return $html;
     ...
     *
     * @param \App\Models\Terms\Country $model
    ...
    public function getColumns(): array
    {
         return [
            ...
            ->addClass('text-center'),
            Column::make('countryname')->title('Country Name'),
            Column::make('countrycode')->title('Country Code'),
            Column::make('code')->title('Short Code'),

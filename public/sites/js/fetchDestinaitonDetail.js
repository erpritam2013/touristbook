(function($){
   ...
   setTimeout(function() {
    ...
    $('body.destination-detail-page #tab-tourism_zone #tourism-zone-div .tab-content td *,body.destination-detail-page #tab-tourism_zone #tourism-zone-div .tab-content td,body.destination-detail-page #tab-tourism_zone #tourism-zone-div .tab-content th,body.destination-detail-page #tab-tourism_zone #tourism-zone-div .tab-content th *').removeAttr('style')
...
const getData = function(ajaxurl,location_id) { 
    return $.ajax({
        type: "GET",
        dataType: "html",
        url: ajaxurl,
...
async function fetchDataByajax(t_endpoint,t_lo_id,t_id) {
  try {
    const res = await getData(t_endpoint,t_lo_id)
...
window.fetchDestinaitonDetail = function(ele){
    ...
    if (typeof target_element != 'undefined') {
        ...
        fetchDataByajax(endpoint,location_id,get_id);

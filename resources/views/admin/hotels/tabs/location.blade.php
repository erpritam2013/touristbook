...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        <input type="number" class="form-control" id="latitude" name="latitude" value="{{$hotel->detail->latitude ?? ''}}">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        <input type="number" class="form-control" id="longitude" name="longitude" value="{{$hotel->detail->longitude ?? ''}}">
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-7">
        <input type="number" class="form-control" id="zoom_level" name="zoom_level" value="{{$hotel->detail->zoom_level ?? 1}}">
    </div>
</div>

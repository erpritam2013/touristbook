<div class="form-group row">
    <label class="col-lg-5 col-form-label" for="hotel-as-feature">Allowed full day booking<br /><small>
    ...
    <div class="col-lg-7">
        <label class="col-form-label">
            <input type="radio" name="is_allowed_full_day" value="1" {!!get_edit_select_check_pvr_old_value('is_allowed_full_day', $hotel ?? "" ,'is_allowed_full_day',1, 'checked' )!!}>&nbsp;On
        </label>
        <label class="col-form-label">
            <input type="radio" name="is_allowed_full_day" {!!get_edit_select_check_pvr_old_value('status', $hotel ?? "" ,'is_allowed_full_day',0, 'checked' )!!} value="0">&nbsp;Off
        </label>
    </div>
</div>

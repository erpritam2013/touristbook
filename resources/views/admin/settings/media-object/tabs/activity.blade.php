@section('setting_action', route('admin.settings.theme-settings.store','activity'))
<form class="form-valide" id="setting-form-activity" action="@yield('setting_action')" method="post"><!-- Form Start -->
  {{ csrf_field() }}

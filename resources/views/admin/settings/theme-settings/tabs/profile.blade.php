@section('setting_action_profile', route('admin.settings.theme-settings.store','profile'))
<form class="form-valide" id="setting-form-profile" action="@yield('setting_action_profile')" method="post">
	{{ csrf_field() }}

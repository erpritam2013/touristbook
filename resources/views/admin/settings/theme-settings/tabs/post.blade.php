@section('setting_action_post', route('admin.settings.theme-settings.store','post'))
<form class="form-valide" id="setting-form-post" action="@yield('setting_action_post')" method="post"><!-- Form Start -->
  {{ csrf_field() }}

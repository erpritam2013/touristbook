@section('setting_action_location', route('admin.settings.theme-settings.store','location'))
<form class="form-valide" id="setting-form-location" action="@yield('setting_action_location')" method="post"><!-- Form Start -->
  {{ csrf_field() }}

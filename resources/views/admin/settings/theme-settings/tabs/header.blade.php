@section('setting_action_header', route('admin.settings.theme-settings.store','header'))
<form class="form-valide" id="setting-form-header" action="@yield('setting_action_header')" method="post">
    {{ csrf_field() }}

...
{{--
        ...
        <input type="text" class="form-control media-txt-only {{ $class ?? '' }}" readonly="true"  id="{{ $id ?? '' }}" placeholder="Enter {{ $label ?? '' }}..." value="@if(is_array($value) && isset($value[0]) && isset($value[0]['url'])  ){{$value[0]['url']}}@endif"   />

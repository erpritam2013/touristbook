        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <select class="form-control single-select-placeholder-touristbook {{$elemClass}}" id="{{$type.'-tsign-'.$key.'-tsign-'.$controlId}}" name="{{$type}}[{{$key}}][{{$controlId}}]" placeholder="Enter {{$typeFields[$controlId]['label']}}...">

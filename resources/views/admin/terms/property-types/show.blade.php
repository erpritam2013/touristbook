   ...
   <div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">{{$title}}&nbsp;{!!get_fontawesome_icon_html($property_type->icon,'fa-lg')!!}</h4>
            <div align="right">
            	<a href="{{route('admin.terms.property-types.edit',$property_type->id)}}" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>

        ...
        <div class="card">
            <div class="card-header">
                ...
                <div align="right" class="all-a">
                    ...
                    <a href="{{route('admin.terms.types.create')}}" class="btn btn-outline-primary btn-xs">Add New Type</a>
                </div>
            </div>

            <div class="card-body type_list entity-list">
                    ...
                    <table id="example" class="display" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{get_time_format($type->created_at)}}</td>
                                <td>{{get_time_format($type->updated_at)}}</td>
                                <td>
                                    <a href="{{route('admin.terms.types.edit',$type->id)}}" class="btn btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
                                    <a href="{{route('admin.terms.types.show',$type->id)}}" class="btn btn-info" title="View"><i class="fa fa-file"></i></a>
                                    <a href="javascript:void(0);" class="btn btn-danger del_entity_form" title="Delete" item_id="{{$type->id}}" data-text="Type"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
          ...
          <form id='delete_entity_form' method="POST" action="{{route('admin.terms.types.index')}}" style="display: none">
                              {{ csrf_field() }}

<!-- Activity zone title -->
{!!inputTemplate(['name'=> 'sub_title','label'=>'Activity Zone Title','value'=>$activity_zone->sub_title ?? '','id' => ""])!!}
<!-- country -->
{!!selectBoxTemplate(['items' => $countries, 'name'=> 'country','selected'=>$activity_zone->country ?? "",'label'=>'Country'])!!}
...
{!!textareaTemplate(['name'=> 'activity_zone_description','label'=>'Description','value'=>$activity_zone->activity_zone_description ?? '','id' => "activity-zone-disc",'class' => "ckeditor"])!!}

        ...
        <div class="container">
            <div class="row mb-5">
                ...
                <div class="col-md-4 d-lg-flex align-items-center justify-content-end"><a href="#"
                        class="blist text-sm ml-2"> See all cities<i class="fas fa-angle-double-right ml-2"></i></a></div>
            </div>
            <div class="row">
                <div class="col-md-6"> <a href="#">
                        <div class="list-mig-like-com">
                            <div class="list-mig-lc-img"> <img src="{{asset('sites/images/tour/home.jpg')}}" alt=""> </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-6"> <a href="#">
                                <div class="list-mig-like-com">
                                    <div class="list-mig-lc-img"> <img src="{{asset('sites/images/tour/home2.jpg')}}" alt=""> </div>
                        ...
                        <div class="col-md-6"> <a href="#">
                                <div class="list-mig-like-com">
                                    <div class="list-mig-lc-img"> <img src="{{asset('sites/images/tour/home3.jpg')}}" alt=""> </div>
                                    <div class="list-mig-lc-con list-mig-lc-con2">
                                        <h5>Australia</h5>
                                        <p>81 Cities </p>
                                    </div>
                        ...
                        <div class="col-md-6"> <a href="#">
                                <div class="list-mig-like-com">
                                    <div class="list-mig-lc-img"> <img src="{{asset('sites/images/tour/home4.jpg')}}" alt=""> </div>
                                    <div class="list-mig-lc-con list-mig-lc-con2">
                                        <h5>Germany</h5>
                                        <p>81 Cities </p>
                                    </div>
                        ...
                        <div class="col-md-6"> <a href="#">
                                <div class="list-mig-like-com">
                                    <div class="list-mig-lc-img"> <img src="{{asset('sites/images/tour/home1.jpg')}}" alt=""> </div>
                                    <div class="list-mig-lc-con list-mig-lc-con2">
                                        <h5>India</h5>
                                        <p>81 Cities </p>
                                    </div>

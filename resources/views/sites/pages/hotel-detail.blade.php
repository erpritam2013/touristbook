  ...
  <div class="section mt-4">
    <div class="row bt1pxe9ecef">
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        ...
        <div class="listroBox">
          <figure><a href="{{route('location',$explore_location->slug)}}"><img src="{{asset('sites/images/hotels/room1.jpg')}}" class="img-fluid" alt="">
...
<div class="col-lg-3 col-md-12 col-sm-12 right_Details">
  ...
  <div class="ml-lg-4 sticky-top" style="top: 100px;">
    <div class="view-on-map widget-box rounded mb-lg-4 border-solid-d7dce3">
      <img src="https://touristbook.s3.ap-south-1.amazonaws.com/wp-content/uploads/2021/11/hotel-location-icon-4.jpg" height="200">
    ...
    <div class="view-important-note p-4 rounded border-solid-d7dce3" style="color: #000000;">
      ...
      <ul>
        <li><span>To go through a hotel's Cancellation and Refund Policy before you confirm your booking.</span></li>
        ...
        <li><span>To visit the <strong>social media linkages</strong> of the hotel to get more information/authenticity. </span></li>
      </ul>
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-12">
  @if(isset($nearByHotel) && !empty($nearByHotel))
  <section class="Categories pt10 hotelsamilar">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <p class="mt-0 mb-0 nopadding st-heading-section">Similar Hotels</p>
          {{--<h1 class="paddtop1 font-weight lspace-sm">You may also like </h1>--}}
        </div>
        <div class="col-md-4 d-lg-flex align-items-center justify-content-end"><a href="{{route('hotels')}}" class="blist text-sm ml-2"> See all Hotels<i class="fas fa-angle-double-right ml-2"></i></a></div>
      </div>
      <div class="row">
            ...
            <div class="listroBoxmain">
              ...
              <ul>
                <li class="mt-0 mb-0">
                 ...
                 <li class="mt-0 mb-0">
                  {{--<a href="{{route('hotel',$near_hotel->slug)}}" class="btn btn-grad text-white mt-0 mb-0 btn-sm">View Detail</a>--}}

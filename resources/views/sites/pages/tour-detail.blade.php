				...
				<div class="col-lg-9 col-md-12 col-sm-12 ">
					...
					<div class="custom-content" id="custom-content">
						...
						<div class="tab-pane" id="id-proofs-tab">
							...
							@else
							<div class="alert alert-warning mt15">No Helpful Facats Found.</div>
					...
					<div class="notices listingDetails booking-search mt-4 ">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 bt1pxe9ecef">
							<section class="Categories pt10 tour-samilar">
								<div class="container">
									<div class="row">
										<div class="col-md-8">
											<p class="mt-0 mb-0 nopadding st-heading-section">Similar Tours</p>
											{{--<h1 class="paddtop1 font-weight lspace-sm">You may also like </h1>--}}
										</div>
										<div class="col-md-4 d-lg-flex align-items-center justify-content-end"><a href="{{route('our-packages')}}" class="blist text-sm ml-2"> See all tours<i class="fas fa-angle-double-right ml-2"></i></a></div>
									</div>
									<div class="row">
										...
										<div class="col-md-3 col-sm-3  col-xs-12">
											<div class="listroBox">
												<figure><a href="{{route('tour',$near_tour->slug)}}"><img src="https://touristbook.s3.ap-south-1.amazonaws.com/wp-content/uploads/2023/04/collage-2022-09-04T081031.435-1.jpg" class="img-fluid" alt="">
												...
												<div class="listroBoxmain p-2">
													...
													<ul>
														<li class="mt-0 mb-0">
															...
															<li class="mt-0 mb-0">
																{{--<a href="{{route('tour',$near_tour->slug)}}" class="btn btn-grad text-white mt-0 mb-0 btn-sm">View Detail</a>--}}
													...
													<section class="Categories pt10 destination-samilar">
														<div class="container">
															...
															<div class="row">
																...
																<div class="col-md-3 col-sm-3  col-xs-12">
																	<div class="listroBox">
																		<figure><a href="{{route('location',$near_location->slug)}}"><img src="https://touristbook.s3.ap-south-1.amazonaws.com/wp-content/uploads/2023/07/banner-image-2-270x200.jpg" class="img-fluid" alt="">
																			{{--<div class="read_more"><span>View Detail</span></div>--}}
																		</a> </figure>
																		<div class="listroBoxmain p-2">

		...
		<div class="card">
			<div class="card-header main-title-tal" data-toggle="collapse" data-target="#{{$parent_name_l}}" aria-expanded="true">  
				...
				<div class="custom-checkbox">
					<input type="checkbox" id="parent_other_packages_{{$tal_count}}" name="other_packages[]"
					class="custom-control-input filter-option filter-other-package" value="{{$key}}" data-parent="{{$parent_name_l}}">

			...
			<div class="item-border">
				<div class="item">
					<div class="thumbnail shopaholics-anonymous-image">
						@php 
						$shopaholics_anonymous_image = (!empty($shopaholics_anonymous['shopaholics_anonymous-image']) && isset($shopaholics_anonymous['shopaholics_anonymous-image'][0]['id']))?getConversionUrl($shopaholics_anonymous['shopaholics_anonymous-image'][0]['id'],'270x200'):null;
						@endphp
